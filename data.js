...
// Coupon Codes
const coupons = [
    {code:'NONE',discount:0,desc:'No coupon',type:'all'},
    {code:'HAULA ELEPHANT',discount:30,desc:'Flat 30% OFF on all items',type:'all'},
    {code:'GENDUR-GIT-KY',discount:35,desc:'Flat 35% OFF on elephants only',type:'elephant'}
];
...
const soundConfig = {
    ...
    files: {
        addCart: 'https://assets.mixkit.co/active_storage/sfx/2482/2482-preview.mp3', // Real elephant trumpet
        success: 'https://assets.mixkit.co/active_storage/sfx/1464/1464-preview.mp3', // Success chime
        error: 'https://assets.mixkit.co/active_storage/sfx/1457/1457-preview.mp3' // Error beep
    }
};
